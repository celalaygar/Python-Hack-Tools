# Python dilinde bir FTP sunucusuna brute force saldırısı yapmak için basit bir örnek kod bulunmaktadır. 
# Ancak, lütfen unutmayın ki, bu tür saldırılar yasa dışıdır ve başka kişilerin veya sistemlerin 
